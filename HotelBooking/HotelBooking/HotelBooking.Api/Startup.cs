...
using HotelBooking.Infra.Repository;
...
namespace HotelBooking.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IHotelAddressService, HotelAddressService>();
            services.AddScoped<IHotelAddressRepository, HotelAddressRepository>();
