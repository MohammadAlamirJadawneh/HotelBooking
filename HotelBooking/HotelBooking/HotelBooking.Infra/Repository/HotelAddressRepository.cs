...
namespace HotelBooking.Infra.Repository
{
    public class HotelAddressRepository : IHotelAddressRepository
    {
        ...
        public void CreateHotelAddress(HotelAddress hotelAddress)
        {
            ...
            HotelAddress hotelAddress1 = new HotelAddress();
            hotelAddress1.HotelAddressId = hotelAddress.HotelAddressId;
            hotelAddress1.HotelAddressCity = hotelAddress.HotelAddressCity;



            dataContext.HotelAddresses.Add(hotelAddress1); /**/
